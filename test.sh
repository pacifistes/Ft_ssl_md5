...
# # # BASE 64
for e in {0..100} ; do echo "$e :"; ./ft_ssl base64 -i test_tmp/f_$e -o test_tmp/base64_$e ; openssl base64 -in test_tmp/f_$e -out test_tmp/openssl_base64_$e ; diff test_tmp/base64_$e test_tmp/openssl_base64_$e; done
